...
class TestGameGUI:
    ...
    def test_run_game_session_success(self, gui):
        ...
        with patch('src.gui.GUIPlaySession') as mock_session_class:
            mock_session = Mock()
...
class TestGUIPlaySession:
    ...
    @patch('src.gui.GUIPlaySession.setup_player')
    @patch('src.gui.GUIPlaySession.display_instructions')
    @patch('src.gui.GUIPlaySession.play_games')
    @patch('src.gui.GUIPlaySession.prize_booth_interaction')
    @patch('src.gui.GUIPlaySession.final_results')
    @patch('src.gui.GUIPlaySession.conclude')
